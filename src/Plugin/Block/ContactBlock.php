...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    return array(
      '#markup' => $this->t('@org, @loc. <br/>Email id : <a href="mailto:@mail">@mail</a> <br/>Phn: @phn. <br/>Address: @add', array('@add'=> $org_add,'@phn'=> $org_phn,'@mail'=> $org_mail,'@org'=> $org_name,'@loc' => $org_loca)),
    );
  }
  ...
  public function blockValidate($form, FormStateInterface $form_state) {
    ...
    if (is_numeric($org_name)) {
      drupal_set_message('needs to be an integer Character', 'error');
